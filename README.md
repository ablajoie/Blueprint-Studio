...
Version 0.1 currently supports Projects, Solutions, Objects, Fields, Relationships, Global Value Sets, dependent picklists, and clickable schema visualization. The next vertical slices add Discovery, basic Layouts, Requirements, Decisions, and configurable Health Rules.
