...
export interface ExperienceModel { layouts: LayoutDefinition[]; }
...
export interface SecurityPrincipal { id: UUID; name: string; description?: string; }
export interface PermissionSetGroup extends SecurityPrincipal { permissionSetIds: UUID[]; mutedPermissionSetIds: UUID[]; }
...
export interface HealthRuleOverride { ruleId: UUID; enabled?: boolean; severity?: HealthRule["severity"]; }
export interface RecordNameDefinition { label: string; dataType: "text" | "auto-number"; displayFormat?: string; }
export interface ArtifactOrigin { type: "created" | "imported" | "ai-generated"; sourceId?: string; importedAt?: ISODateTime; }
export interface TemplateDefinition { id: UUID; name: string; type: string; payload: Record<string, unknown>; }
export interface AuditInfo { createdAt: ISODateTime; updatedAt: ISODateTime; createdBy?: string; updatedBy?: string; }
